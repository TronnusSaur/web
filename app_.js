...
const ct_info_valores = document.querySelector('#ct-info_valores')
const ct_info_valores_blocks = document.querySelector('#ct-info_valores-blocks')
const ct_info_valores_blocks = document.querySelector('#ct-info_valores-blocks')
...
/** */
document.getElementsByClassName('swiper').style.margin = '0 5rem 0 5rem'; 